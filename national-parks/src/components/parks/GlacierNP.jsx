...
class GlacierNP extends NationalPark {

  constructor(props) {
    super(props);
    this.state.name = "Glacier"
    this.state.image = "/glacier.jpg"
    this.state.est = "May 11, 1910"
    this.state.description = "A showcase of melting glaciers, alpine meadows, carved valleys, and spectacular lakes." +
